...
<body>
    <div class="email-container">
        ...
        <div class="email-body">
            <h2 class="greeting">Hello <?php echo e($userName); ?>,</h2>
            <p class="instruction">
        ...
        <div class="email-footer">
            <p class="footer-note">© <?php echo e(date('Y')); ?> Mangalam Healthy Foods. Sethiyathope, Cuddalore, Tamil Nadu.</p>
            <p class="footer-note" style="margin: 0;">Automated message — please do not reply directly to this email.</p>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\devar\OneDrive\Desktop\product-app\backend\resources\views/emails/password_reset_otp.blade.php ENDPATH**/ ?>