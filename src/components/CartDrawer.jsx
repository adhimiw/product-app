            ...
            <div className="cart-drawer-content">
                ...
                <div className="cart-header">
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                        ...
                        <h3 className="cart-drawer-title">{t('cartTitle')} ({totalQty})</h3>
                    </div>
                ...
                <div className="cart-items">
                    {cart.length === 0 ? (
                        <div className="cart-empty-message">
                            <span style={{ fontSize: '2.2rem', marginBottom: '10px', display: 'block' }}>🛍️</span>
                            <p style={{ fontWeight: 700, color: 'var(--color-primary)', marginBottom: '4px', fontSize: '0.9rem' }}>{t('cartEmpty')}</p>
                            <p style={{ fontSize: '0.78rem', color: '#646a66' }}>Add our 100% soak-sprouted health mixes to begin.</p>
                        </div>
                    ) : (
                        cart.map((item, index) => {
                            ...
                            return (
                                <div className="cart-item-card" key={`${item.id}-${index}`}>
                                    ...
                                    <div className="cart-item-details">
                                        ...
                                        <div className="cart-item-badge">100% Sprout-Activated</div>
                                        <div className="cart-item-price-row">
                                            <span className="cart-item-price">₹{itemPriceNum} × {item.quantity}</span>
                                            <span className="cart-item-total">₹{itemPriceNum * item.quantity}</span>
                                        </div>
                                    </div>
                ...
                <div className="cart-drawer-footer" style={{ opacity: cart.length === 0 ? 0.6 : 1 }}>
                    ...
                    <p style={{ fontSize: '0.72rem', color: '#646a66', marginBottom: '14px', textAlign: 'center' }}>
